...
int main (int argc, char *argv[])
{
  ...
  cmd.AddValue ("queueDiscType", "Set Queue disc type to PI or PIE", queueDiscType);
  ...
  if ((queueDiscType != "PI") && (queueDiscType != "PIE"))
    {
      std::cout << "Invalid queue disc type: Use --queueDiscType=PI or --queueDiscType=PIE" << std::endl;
      exit (1);
    }
